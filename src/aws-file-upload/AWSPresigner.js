...
// });
AWS.config = new AWS.Config({
  accessKeyId:'AKIA3ITE6B4X6JJKJV6U',//process.env.S3_KEY, // stored in the .env file
  secretAccessKey: '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',//process.env.S3_SECRET, // stored in the .env file
...
const Bucket = 'ecommerce-stock-images'
